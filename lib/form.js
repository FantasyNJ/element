...
var external_scroll_into_view_if_needed_ = __webpack_require__(48);
...
/* harmony default export */ var formvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    validate: function validate(callback) {
      ...
      if (typeof callback !== 'function' && window.Promise || typeof callback === 'function' && callback.returnPromise) {
        var oldCb = callback;
        promise = new window.Promise(function (resolve, reject) {
          callback = function callback(valid, invalidFields, invalidFormItemComponents) {
            if (oldCb) {
      ...
      var invalidFields = {};
      var invalidFormItemComponents = [];
      this.fields.forEach(function (field) {
        field.validate('', function (message, fieldRule) {
          if (message) {
            valid = false;
            invalidFormItemComponents.push(field);
          }
          invalidFields = merge_default()({}, invalidFields, fieldRule);
    ...
    validateAndScroll: function validateAndScroll() {
      ...
      var newCb = function newCb(valid, invalidFields, invalidFormItemComponents) {
        if (!valid) {
          if (invalidFormItemComponents && invalidFormItemComponents[0] && invalidFormItemComponents[0].$el) {
            var firstErrorNode = invalidFormItemComponents[0].$el;
            external_scroll_into_view_if_needed_default()(firstErrorNode, options);
          }
        }
        if (hasCallback) {
